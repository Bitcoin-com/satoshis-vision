...
(0, _jquery2.default)(".marketing-site-hero .button").click(function () {
    (0, _jquery2.default)('html,body').animate({
        scrollTop: (0, _jquery2.default)(".intro").offset().top }, 'slow');
});

(0, _jquery2.default)(".speakers-list .button").click(function () {
    (0, _jquery2.default)('html,body').animate({
        scrollTop: (0, _jquery2.default)(".feature-list").offset().top }, 'slow');
});
